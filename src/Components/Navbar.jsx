    ...
    <div className="p-2">
      <div className="flex justify-between">
        ...
        <div className="md:hidden lg:hidden">
          ...
          fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 cursor-pointer float-right">
        ...
        {toggle?<ul className="flex flex-col mt-8 p-4 bg-gray-300">
